## Contributing to EthernetWebServer_SSL_STM32
...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/EthernetWebServer_SSL_STM32_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/EthernetWebServer_SSL_STM32_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/EthernetWebServer_SSL_STM32_GitHub$ bash utils/restyle.sh
```
