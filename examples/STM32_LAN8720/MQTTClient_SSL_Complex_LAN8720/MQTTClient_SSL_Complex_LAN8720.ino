...
const char *ID        = "MQTTClient_SSL-Complex_LAN8720";  // Name of our device, must be unique
...
void setup()
{
  ...
  Serial.print("\nStart MQTTClient_SSL_Complex_LAN8720 on " + String(BOARD_NAME));
...
void loop()
{
  ...
  if (now - lastMsg > MQTT_PUBLISH_INTERVAL_MS)
  {
    ...
    String data = "Hello from MQTTClient_SSL_Complex_LAN8720 on " + String(BOARD_NAME) + ", millis = " + String(millis());
