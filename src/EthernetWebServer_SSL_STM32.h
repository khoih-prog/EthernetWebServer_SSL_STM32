...
#define ETHERNET_WEBSERVER_SSL_STM32_VERSION      "EthernetWebServer_SSL_STM32 v1.4.5"

#define ETHERNET_WEBSERVER_SSL_STM32_VERSION_MAJOR    1
#define ETHERNET_WEBSERVER_SSL_STM32_VERSION_MINOR    4
#define ETHERNET_WEBSERVER_SSL_STM32_VERSION_PATCH    5

#define ETHERNET_WEBSERVER_SSL_STM32_VERSION_INT      1004005
