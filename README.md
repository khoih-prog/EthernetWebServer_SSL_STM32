...
3. Install [**EthernetWebServer_SSL_STM32** library](https://platformio.org/lib/show/xxxxx/EthernetWebServer_SSL_STM32) by using [Library Manager](https://platformio.org/lib/show/xxxxx/EthernetWebServer_SSL_STM32/installation). Search for **EthernetWebServer_SSL_STM32** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
